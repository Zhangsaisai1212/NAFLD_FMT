...
rm(list = ls())
setwd("C:\\Users\\dengwei\\Google Drive\\HKU\\01.Project\\03.20200307_NAFLD\\scale_reads_to_35M\\microbitas\\PcoA\\human")
data <- read.xlsx("merged_human_genus.xlsx", sheet = 1)
...
sample_site$type <- factor(sample_site$type, levels = c('healthy', 'lean_NAFLD', 'obese_NAFLD'))
